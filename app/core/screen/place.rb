    ...
    if (!my_ally.nil? && !target.vid.nil?) 
      ...
      if (!village_info.village.player_id.nil?)
        ...
        if (!player_info.ally_id.nil? && my_ally.aid == player_info.ally_id) 
          msg = "Estou tentando atacar o player #{village_info.village.player_id} na village #{village_info.village.vid} mas ele é da ally #{player_info.ally_id} e eu sou da ally #{my_ally.aid}"
